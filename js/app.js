...
const App = (() => {
  const views = [ViewProgramacaoAnual, ViewProgramacaoMensal, ViewUnidades, ViewEmpresas, ViewCatalogo, ViewColaboradores, ViewFuncoes, ViewCalendario, ViewHistorico, ViewUsuarios];
