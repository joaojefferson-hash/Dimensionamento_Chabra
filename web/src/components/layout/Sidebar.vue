<script setup>
/* Menu lateral: telas agrupadas por seção, filtradas pelo papel; usuário e Sair no rodapé. */
...
<template>
  <aside class="flex w-[268px] shrink-0 flex-col bg-primary text-white">
    ...
    <nav class="flex-1 px-3" aria-label="Telas">
